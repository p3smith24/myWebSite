...
function getWords() {
	...
	*/
	...
	userAnswer1[0] = document.getElementById("inputName").value;
	userAnswer1[1] = document.getElementById("inputAnimal1").value;
	userAnswer1[2] = document.getElementById("inputName").value;
	userAnswer1[3] = document.getElementById("inputAdjective1").value;
	userAnswer1[4] = document.getElementById("inputPlace").value;
	userAnswer1[5] = document.getElementById("inputPlace").value;
	userAnswer1[6] = document.getElementById("inputName").value;
	userAnswer1[7] = document.getElementById("inputObject1").value;
	userAnswer1[8] = document.getElementById("inputNoun").value;
	userAnswer1[9] = document.getElementById("inputName").value;
	userAnswer2[0] = document.getElementById("inputSize").value;
	userAnswer2[1] = document.getElementById("inputAdjective2").value;
	userAnswer2[2] = document.getElementById("inputAnimal2").value;
	userAnswer2[3] = document.getElementById("inputName").value;
	alert("hi");
	//userAnswer2[4] = document.getElementById("inputAnimal2").value;
	alert("one");
	/*userAnswer2[5] = document.getElementById("inputName").value;
	userAnswer2[6] = document.getElementById("inputName").value;
	userAnswer2[7] = document.getElementById("inputObject2").value;
	userAnswer2[8] = document.getElementById("inputPtverb").value;
	userAnswer2[9] = document.getElementById("inputName").value;
	userAnswer3[0] = document.getElementById("inputAnimal3").value;
